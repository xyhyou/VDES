...
namespace VDES
{
    ...
    public:
        ...
        * @param[in]  outboxSize -  maximum messages in outobx
        * @return     none
        */
        void SetMailBoxCapacity(const uint32_t inboxSize = 100, const uint32_t outboxSize = 100);
        ...
        * @note       The first element of the returned tuple is inbox capacity
        *             The second element of the returned tuple is outbox capacity
        */
        std::tuple<uint32_t, uint32_t> GetMailBoxCapacity(void) const;
        ...
        * @param[in]  portNumber -   [0 - 65535]
        * @param[out] none
        * @return     return true if invoke success.
        ...
        */
        bool SetEthernet(const uint8_t ethID, const std::string &ip, const std::string &mask, 
                         const std::string &gateway, const uint32_t portNumber);
        ...
        */
        ...
        /*
        * @brief	  Get the VDES terminal's version information
        * @param[in]  none
        * @param[out] none
        * @return     VDES terminal's version information
        */
        VersionInfo GetVersionInfo(void) const;

        /*
        * @brief	  Query the VDES terminal's version information
        * @param[in]  none
        * @param[out] none
        * @return     none
        * @note       This interface will send query commands to the VDES terminal.
        *             The result will be notified via the VERSION_INFO event.
        */
        void QueryVersionInfo(void);
