...
namespace VDES
{
    namespace SQLite
    {
        ...
        public:
            ...
            /**
             * @brief Shortcut to test if a field exists
             *
             * @param[in]  fieldName
             *
             * @param[in]  tableName
             *
             * @return true if the fieldName exists.
             *
             * @throw SQLite::Exception in case of error
             *
             * @note Add by xyhyou
             */
            bool fieldExists(const std::string &fieldName, const std::string &tableName);

            /**
             * @brief Shortcut to test if a index exists
             *
             * @param[in]  indexName
             *
             * @param[in]  tableName
             *
             * @return true if the indexName exists.
             *
             * @throw SQLite::Exception in case of error
             *
             * @note Add by xyhyou
             */
            bool indexExists(const std::string &indexName, const std::string &tableName);

            /**
             * @brief Shortcut to build a statement
             *
             * @param[in]  sql command
             *
             * @return statement
             *
             * @throw SQLite::Exception in case of error
             ...
             * @note Add by xyhyou
             */
            Statement buildStatement(const std::string &sql);

            /**
             * @brief Shortcut to check the database is opened or not.
             *
             * @param[in]  none
             *
             * @return none
            ...
            /**
             * @brief Shortcut to open the database.
             *
             * @param[in]  none
             *
             * @return none
            ...
            /**
             * @brief Shortcut to close the database.
             *
             * @param[in]  none
             *
             * @return none
            ...
            */
            ...
            /**
            * @brief Determine if the database is already in transaction mode.
            *
            * @param[in]  none
            *
            * @return none
            ...
            * @note Add by xyhyou
            */
            bool isAutoCommitOn(void) const;
