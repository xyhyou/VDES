...
namespace VDES
{
    namespace SQLite
    {
        ...
        public:
             ...
             * @note Add by xyhyou
             */
            void bind(const int aIndex, const uint64_t aVlaue)
            {
                bind(aIndex, static_cast<int64_t>(aVlaue));
            }
            ...
            {
                bind(apName, static_cast<int64_t>(aValue));
            }
        ...
        private:
            ...
            mutable std::mutex      mMutex;                 //!< Mutex used to protect mColumnNames
            mutable std::once_flag  mInitFlag;              //!< Flag used to initialize mColumnNames
        };
